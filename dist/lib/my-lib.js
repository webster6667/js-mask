(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@babel/runtime/helpers/toConsumableArray'), require('@babel/runtime/helpers/typeof'), require('@helpers/replace-all-pattern-reg-exp-to-placeholder'), require('@helpers/get-mask-symbols-array')) :
    typeof define === 'function' && define.amd ? define(['exports', '@babel/runtime/helpers/toConsumableArray', '@babel/runtime/helpers/typeof', '@helpers/replace-all-pattern-reg-exp-to-placeholder', '@helpers/get-mask-symbols-array'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.myLib = {}, global._toConsumableArray, global.r, global.replaceAllPatternRegExpToPlaceholder, global.getMaskSymbolsArray));
}(this, (function (exports, _toConsumableArray, r, replaceAllPatternRegExpToPlaceholder, getMaskSymbolsArray) { 'use strict';
